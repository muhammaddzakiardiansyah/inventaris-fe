...
const Lab2Pplg = () => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://200.100.0.59:4000/api/v1/laboratories/per-lab/1812f07f-35cf-4e0a-8da6-79e3f0ab706b'
        })
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://200.100.0.59:4000/api/v1/laboratories/spec-per-lab/1812f07f-35cf-4e0a-8da6-79e3f0ab706b'
        })
        .then((res) => {
