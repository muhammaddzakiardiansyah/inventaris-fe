...
const Lab3Pplg = () => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://localhost:4000/api/v1/laboratories/per-lab/164c5398-8df9-4b76-9be0-5208bfab385f'
        })
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://localhost:4000/api/v1/laboratories/spec-per-lab/164c5398-8df9-4b76-9be0-5208bfab385f'
        })
        .then((res) => {
