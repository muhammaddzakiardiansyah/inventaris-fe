...
const Lab4Pplg = () => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://200.100.0.59:4000/api/v1/laboratories/per-lab/97e8aa14-d236-4e97-9537-4da4aa1ac9a1'
        })
        .then((res) => {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'GET',
            url: 'http://200.100.0.59:4000/api/v1/laboratories/spec-per-lab/97e8aa14-d236-4e97-9537-4da4aa1ac9a1'
        })
        .then((res) => {
