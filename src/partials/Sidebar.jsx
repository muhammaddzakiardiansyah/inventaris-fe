        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/dashboard" className="block">
            <div className="flex items-center">
              ...
              <h1 className='text-xl font-medium sm:text-2xl sm:font-bold ml-3 mt-1 text-white'>Code<span className='text-lime-600'>Pelita</span></h1>
            </div>
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/data-spek-semua-barang"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Data Spek semua barang
                              </span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/data-barang-dipulangkan"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Data barang dipulangkan
                              </span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
              ...
              {/* lab pplg */}
              <SidebarLinkGroup activecondition={pathname.includes('/labpplg')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
